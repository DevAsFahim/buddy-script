...
import { useCreateCommentMutation, useGetCommentsQuery } from "../../redux/api/baseApi";
...
const CommentSection = ({ postId }: { postId: string }) => {
  ...
  const { data: response, isLoading: commentsLoading } = useGetCommentsQuery(postId);
        ...
        <div className="_feed_inner_comment_box">
          <form onSubmit={handleSubmit} className="_feed_inner_comment_box_form">
            <div className="_feed_inner_comment_box_content">
              ...
              <div className="_feed_inner_comment_box_content_txt" style={{ display: "flex", gap: "10px" }}>
                <textarea
                ...
                ></textarea>
                <button disabled={isLoading} type="submit" className="btn btn-primary" style={{borderRadius: "40px"}}>
